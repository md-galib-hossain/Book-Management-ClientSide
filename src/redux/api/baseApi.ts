...
//     console.log(data);
//     //if there is no refresh token then there will be no 
//     //access token so that time this if block will be no executed
...
export const baseApi = createApi({
  ...
  tagTypes: ["all-products", "all-users", "all-sales"],
